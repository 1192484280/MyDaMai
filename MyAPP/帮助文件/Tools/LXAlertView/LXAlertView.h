...
typedef void(^LXAlertTextFiledBlock)(NSString *text);

typedef void(^LXAlertGenderBlock)(NSString *gender);

@interface LXAlertView : UIView

@property (nonatomic,copy)LXAlertClickIndexBlock clickBlock;

@property (nonatomic,copy)LXAlertTextFiledBlock textBlock;

@property (nonatomic,copy)LXAlertGenderBlock genderBlock;
...
-(instancetype)initWithGender:(NSString *)title andMsg: (NSString *)one andMsg: (NSString *)two cancelBtnTitle:(NSString *)cancelTitle otherBtnTitle:(NSString *)otherBtnTitle textBlock:(LXAlertTextFiledBlock)bloc;
/**
 *  showLXAlertView
 */
