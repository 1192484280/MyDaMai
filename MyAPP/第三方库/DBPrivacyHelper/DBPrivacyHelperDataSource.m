...
- (NSDictionary *) cellData {
    return @{ @(DBPrivacyTypePhoto):@{ @"header":[self headerText:[@"Photos" localizedString]],
              ...
              @(DBPrivacyTypeAudio):@{ @"header":[self headerText:[@"麦克风" localizedString]],
                                       @"steps":@[ @{ @"desc":[@"Open device settings" localizedString], @"icon":@"dbph_settingsIcon" }, @{ @"desc":[@"Tap on Privacy" localizedString], @"icon":@"dbph_privacyIcon" }, @{ @"desc":[self typeTitle:[@"麦克风" localizedString]], @"icon":@"dbph_photoIcon" }, @{ @"desc":[self typeAllowText:[@"麦克风" localizedString]], @"icon":@"dbph_switchIcon" }]},
              };
}
